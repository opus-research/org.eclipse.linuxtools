...
public class RPMUtils {
	...
	/**
	 * Check if the line passed in could be a valid filename.
	 * <pre>
	 * 	Would match	: test	or test.txt
	 * 	Would not match	: test/
	 * </pre>
	 * @param line The line to check if it is a valid filename.
	 * @return True if filename is valid, false otherwise.
	 */
	public static boolean isValidFileName(String line) {
		boolean rc = false;

...
public class UiUtils {
    ...
    /**
     * @see #resolveDefines(Specfile, String)
     * @param element The element whose specfile contains the string to resolve.
     * @param stringToResolve The string to resolve.
     * @return The resolved string.
     */
    public static String resolveDefines(SpecfileElement element, String stringToResolve) {
        return resolveDefines(element.getSpecfile(), stringToResolve, element);
    }
    ...
    public static String resolveDefines(Specfile specfile, String stringToResolve) {
        return resolveDefines(specfile, stringToResolve, null);
    }

    private static String resolveDefines(Specfile specfile, String stringToResolve, SpecfileElement element) {

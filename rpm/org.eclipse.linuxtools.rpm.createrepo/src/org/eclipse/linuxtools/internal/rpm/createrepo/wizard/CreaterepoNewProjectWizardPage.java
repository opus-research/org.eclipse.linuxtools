 ...
 */
public class CreaterepoNewProjectWizardPage extends
	 ...
	 */
	public CreaterepoNewProjectWizardPage(String pageName) {
		super(pageName);
		setTitle(Messages.CreaterepoNewProjectWizardPage_wizardPageTitle);
		setDescription(Messages.CreaterepoNewProjectWizardPage_wizardPageDescription);
	}

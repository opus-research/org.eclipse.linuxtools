...
public class NewDockerConnectionPageModel extends BaseDatabindingModel {
	...
	public static final String PING_SUCCEEDED = "pingSucceeded";
	...
	/** flag to indicate if ping succeeded. */
	private boolean pingSucceeded = false;
	/** the binding mode (Unix socket or tcp/REST API). */
	...
	public void setPingSucceeded(final boolean pingSucceeded) {
		firePropertyChange(PING_SUCCEEDED, this.pingSucceeded,
				this.pingSucceeded = pingSucceeded);
	}

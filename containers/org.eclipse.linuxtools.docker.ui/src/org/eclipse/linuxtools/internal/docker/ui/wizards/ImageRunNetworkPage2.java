 ...
 *
 */
public class ImageRunNetworkPage2 extends WizardPage {
	 ...
	 *
	 */
	public ImageRunNetworkPage2(final IDockerConnection connection) {
	...
	private void createNetworkModeContainer(final Composite parent) {
		...
		// final Label imageSelectionLabel = new Label(parent, SWT.NONE);
		...
		// $NON-NLS-1$
		GridDataFactory.fillDefaults().align(SWT.FILL, SWT.CENTER)
				.span(2, 1).grab(false, false).applyTo(modeLabel);
		...
		// final IObservableValue enableContainerComboObserver = BeanProperties
		// .value(ImageRunNetworkModel.class,
		// ImageRunNetworkModel.NETWORK_MODE)
		// .observe(model);
		// dbc.bindValue(WidgetProperties.selection().observe(containerButton),
		// enableContainerComboObserver);
		// enableContainerComboObserver
		// .addChangeListener(
		// onEnableContainerMode(containerList, containerButton));
		// toggleContainerCombo(containerList, containerButton);
		...
		// Container list
		final Text otherText = new Text(subContainer, SWT.SINGLE);
	...
	private void toggleContainerCombo(Combo combo, Button containerButton) {
		if (model.getNetworkMode()
				.equals(ImageRunNetworkModel.CONTAINER_MODE)) {
			combo.setEnabled(true);
			containerButton.setSelection(true);
		} else {
			combo.setEnabled(false);
			containerButton.setSelection(false);
		}
	}
	...
	// *
	// */
	// public ImageRunNetworkPage2(final IDockerImage selectedImage,
	// final ILaunchConfiguration lastLaunchConfiguration) {
	// super("ImageSelectionPage3", //$NON-NLS-1$
	// WizardMessages.getString("ImageRunNetworkPage.title"), //$NON-NLS-1$
	// SWTImagesFactory.DESC_BANNER_REPOSITORY);
	// setMessage(WizardMessages.getString("ImageRunNetworkPage.message"));
	// //$NON-NLS-1$
	// setPageComplete(true);
	...
	// *
	// */
	// public ImageRunNetworkPage2(final IDockerConnection selectedConnection) {
	// super("ImageSelectionPage3", //$NON-NLS-1$
	// WizardMessages.getString("ImageRunNetworkPage.title"), //$NON-NLS-1$
	// SWTImagesFactory.DESC_BANNER_REPOSITORY);
	// setMessage(WizardMessages
	// .getString("ImageRunNetworkPage.message")); //$NON-NLS-1$
	...
	// // set validation
	// final ImageSelectionValidator imageSelectionValidator = new
	...
	// .observe(model);
	// final ContainerNameValidator containerNameValidator = new
	...
	// final ValidationStatus validationStatus = (ValidationStatus)
	// containerstatus;
	...
	// addButton
	// .setText(WizardMessages.getString("ImageRunSelectionPage.add"));
	// //$NON-NLS-1$
	...
	// 100);
	// createTableViewerColum(tableViewer,
	// WizardMessages.getString("ImageRunSelectionPage.typeColumn"),
	// //$NON-NLS-1$
	// 50);
	// createTableViewerColum(tableViewer,
	// WizardMessages
	...
	// .grab(true, false).applyTo(addButton);
	// addButton.setText(
	// WizardMessages.getString("ImageRunSelectionPage.addButton"));
	// //$NON-NLS-1$
	...
	// new String[] { ContainerLinkModel.CONTAINER_NAME,
	...
	// 200);
	// createTableViewerColum(tableViewer,
	// WizardMessages.getString("ImageRunSelectionPage.aliasColumn"),
	// //$NON-NLS-1$
	// 150);
	// return tableViewer;
	// }
	...
	//
	// final ContainerLinkModel selectedContainerLink = (ContainerLinkModel)
	// selection
	// .getFirstElement();
	// final ContainerLinkDialog dialog = new ContainerLinkDialog(
	// getShell(), model.getSelectedConnection(),
	...
	// WizardMessages.getString("ImageRunSelectionPage.openStdin"));
	// //$NON-NLS-1$
	// GridDataFactory.fillDefaults().align(SWT.FILL, SWT.CENTER)
	...
	// allocatePseudoTTY
	// .setText(WizardMessages.getString("ImageRunSelectionPage.tty"));
	// //$NON-NLS-1$
	// GridDataFactory.fillDefaults().align(SWT.FILL, SWT.CENTER)
	...
	// WizardMessages.getString("ImageRunSelectionPage.autoRemove"));
	// //$NON-NLS-1$
	// GridDataFactory.fillDefaults().align(SWT.FILL, SWT.CENTER)
	// .span(COLUMNS, 1).grab(true, false)
	...
	// WizardMessages.getString("ImageRunSelectionPage.privileged"));
	// //$NON-NLS-1$
	// GridDataFactory.fillDefaults().align(SWT.FILL, SWT.CENTER)
	...
	// ImageRunNetworkPage2.this.model
	// .getSelectedConnection(),
	// ImageRunNetworkPage2.this.model.getSelectedImageName(),
	...
	// .getStructuredSelection();
	// final ExposedPortModel selectedContainerPort = (ExposedPortModel)
	// selection
	// .getFirstElement();
	// final ContainerPortDialog dialog = new ContainerPortDialog(
	...
	//
	// /**
	// * Sets the default values from the optional given {@link IDockerImage}
	// and
	...
	// try {
	// final FindImageInfoRunnable findImageInfoRunnable = new
	// FindImageInfoRunnable(
	// selectedImage);

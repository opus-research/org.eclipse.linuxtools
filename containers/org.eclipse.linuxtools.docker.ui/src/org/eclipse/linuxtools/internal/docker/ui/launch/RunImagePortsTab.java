...
public class RunImagePortsTab extends AbstractLaunchConfigurationTab
	...
	public void createControl(Composite parent) {
		ILaunchConfigurationTab[] tabs = getLaunchConfigurationDialog()
				.getTabs();
		model = ((RunImageMainTab) tabs[0]).getModel();
	...
	public Image getImage() {
		return SWTImagesFactory.get(SWTImagesFactory.IMG_PORTS_TAB);
	}
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		publishAllPortsButton.setSelection(publishAllPorts);
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		...
		System.out.println("performapply portsList " + portsList);
		configuration.setAttribute(
				IRunDockerImageLaunchConfigurationConstants.PUBLISH_PORTS,
				portsList);
	}

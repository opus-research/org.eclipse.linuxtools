...
public class ImageTagSelectionPage extends WizardPage {
	...
	public void createControl(final Composite parent) {
		...
		addTableViewerColum(tableViewer,
				...
				SWT.NONE, SWT.LEFT, 75,
 new ImagePulledColumnLabelProvider());
	...
	static class ImagePulledColumnLabelProvider
		...
		boolean doPaint(final Object element) {
			// TODO: need to see how the 'pulled' field should be populated:
			// should it be the DockerRegistry's work ? Use a BaseRegistry with
			// the selected Docker connection maybe ?
			// and add the 'pulled' boolean as a constructor arg ?
			// OR
			// return a RepositoryTag from the DockerRegistry, perform the
			// verification in the UI and wrap the result in a
			// DockerImageTagSearchResult bean

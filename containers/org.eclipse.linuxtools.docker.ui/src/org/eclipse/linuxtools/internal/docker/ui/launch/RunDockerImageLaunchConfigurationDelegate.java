...
public class RunDockerImageLaunchConfigurationDelegate
	...
	public IDockerContainerConfig getDockerContainerConfig(
		...
		String memory = lconfig.getAttribute(IRunDockerImageLaunchConfigurationConstants.MEMORY_LIMIT, (String)null);
		String cpuShares = lconfig.getAttribute(
				IRunDockerImageLaunchConfigurationConstants.CPU_PRIORITY,
				(String) null);
		if (memory != null && cpuShares != null) {

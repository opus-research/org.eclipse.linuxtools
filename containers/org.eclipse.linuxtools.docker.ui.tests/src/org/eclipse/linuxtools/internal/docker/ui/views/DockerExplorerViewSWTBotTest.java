...
public class DockerExplorerViewSWTBotTest {
	...
	public TestWatcher watcher = new TestWatcher() {
		...
		protected void starting(final Description description) {
			System.err.println("Starting " + description.getClassName() + "." + description.getMethodName());
		}
	};
	...
	public void shouldRefreshImagesAndShowChanges() throws Exception {
		...
		System.err.println("Images before refresh:" + dockerConnection.getImages());
		dockerExplorerViewTreeBot.contextMenu("Refresh").click();
		Thread.sleep(2000);
		System.err.println("Images after refresh:" + dockerConnection.getImages());
		imagesTreeItem.expand();
		
		System.err.println("Number of images after node expansion:" + SWTUtils.getTreeItem(dockerExplorerViewBot, "Test (null)", "Images").getItems().length);

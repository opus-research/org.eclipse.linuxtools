...
public class NewDockerConnectionSWTBotTest {
	...
	private static SWTBotView dockerExplorerView;
	private static SWTBotToolbarButton addConnectionButton;
	...
	public static void beforeClass() throws Exception {
		...
		dockerExplorerView = bot.viewById("org.eclipse.linuxtools.docker.ui.dockerExplorerView");
		dockerExplorerView.show();

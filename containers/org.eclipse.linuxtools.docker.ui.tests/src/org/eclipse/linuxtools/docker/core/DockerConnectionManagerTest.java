...
public class DockerConnectionManagerTest {
	...
	@After
	public void reset() {
		dockerContainersRefreshManager.getConnections()
				.iterator().forEachRemaining(connection -> dockerContainersRefreshManager.removeContainerRefreshThread(connection));
	}

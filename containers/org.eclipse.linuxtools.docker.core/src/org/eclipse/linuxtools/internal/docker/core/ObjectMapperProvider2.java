...
public class ObjectMapperProvider2 implements ContextResolver<ObjectMapper> {
	...
	static {
		...
		MODULE.addDeserializer(ImmutableSet.class,
				new ImmutableSetDeserializer());
	...
	private static class SetSerializer extends JsonSerializer<Set> {
		...
		public void serialize(final Set value, final JsonGenerator jgen,
			...
			final Map map = (value == null) ? null
					: Maps.asMap(value, VOID_VALUE);
	...
	private static class SetDeserializer extends JsonDeserializer<Set> {
		...
		@Override
		public Set<?> deserialize(final JsonParser jp,
	...
	private static class ImmutableSetSerializer
		...
		@Override
		public void serialize(final ImmutableSet value,
	...
	private static class ImmutableSetDeserializer
		...
		@Override
		public ImmutableSet<?> deserialize(final JsonParser jp,
				final DeserializationContext ctxt) throws IOException {
			final Map map = OBJECT_MAPPER.readValue(jp, Map.class);

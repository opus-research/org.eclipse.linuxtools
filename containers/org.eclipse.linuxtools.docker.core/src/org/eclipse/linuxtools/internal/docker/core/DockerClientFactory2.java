...
import org.eclipse.linuxtools.internal.docker.core.DefaultDockerClient2.Builder;
...
public class DockerClientFactory2 {
	 ...
	 */
	public DockerClient2 getClient(
	...
	public DockerClient2 getClient(
			...
			throws DockerCertificateException {
		final Builder builder = DefaultDockerClient2.builder();

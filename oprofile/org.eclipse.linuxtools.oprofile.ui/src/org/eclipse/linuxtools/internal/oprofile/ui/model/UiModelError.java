...
public class UiModelError implements IUiModelElement {
	...
	/**
	 * Return null since this is an error element and does not have any children
	 * @return null
	 */
	...
	/**
	 * Return false since the element does not have any children
	 */
	...
	/**
	 * Return null since this is an error element and does not have any parent
	 * @return null
	 */

...
public class CheckJavadoc {
    ...
    @Before
    public void setUp() {
    	IPath p = JavaDocPlugin.getDefault().getStateLocation().append("C"); //$NON-NLS-1$
    ...
    */
    ...
    public void testHelpTopic() {
        ...
        IPath testRoot = wsRoot.append("javadoc_root"); //$NON-NLS-1$
        IPreferenceStore ps = JavaDocPlugin.getDefault().getPreferenceStore();
        ps.setValue(PreferenceConstants.JAVADOCS_DIRECTORY, testRoot.toOSString());

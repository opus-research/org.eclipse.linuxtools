...
public class StatComparisonView extends ViewPart {
	...
	private StatComparisonData diffData;
	...
	public void createPartControl(Composite parent) {
		...
		IPerfData statsDiff = PerfPlugin.getDefault()
				.getStatDiffData();
		if (statsDiff != null) {
			diffData = (StatComparisonData)statsDiff;
	 ...
	 */
	public static IViewPart getView(String sID) {
		IViewPart view = null;
		try {
			view = PlatformUI
					.getWorkbench()
					...
					.getActivePage()
					.showView(PerfPlugin.STAT_DIFF_VIEW_ID, sID,

...
public class LaunchRemoteTest extends AbstractRemoteTest {
	...
	private final String EXTERNAL_PROJECT_PATH = "remotetools://localhost/tmp/eclipse-perf-ext_project_test"; //$NON-NLS-1$
	...
	protected void setUp() throws Exception {
		proj = createExternalProjectAndBuild(FrameworkUtil.getBundle(this.getClass()),
				PROJECT_NAME, EXTERNAL_PROJECT_PATH, SOURCE_FILE);

		config = createConfiguration(proj);

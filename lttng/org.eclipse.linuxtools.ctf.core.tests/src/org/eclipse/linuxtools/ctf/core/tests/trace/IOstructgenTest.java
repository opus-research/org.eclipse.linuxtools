...
public class IOstructgenTest {
    ...
    static final String metadataDecs = "typealias integer { size = 8; align = 8; signed = false; } := uint8_t;\n"
            ...
            + "        uint32_t stream_id;\n" + "    };\n" + "};\n" + "\n";
    @SuppressWarnings("nls")
    static final String environmentMD = "env {\n"
            + "    hostname = \"DemoSystem\";\n"
            + "    vpid = 1337;\n"
            + "    procname = \"demo\";\n"
            ...
            + "};\n" + "\n";
    @SuppressWarnings("nls")
    static final String clockMD = "clock {\n" + "    name = monotonic;\n"
    ...
    @SuppressWarnings("nls")
    static final String ctfHeaders =
    ...
    @SuppressWarnings("nls")
    static final String ctfBody = "stream {\n"
            + "    id = 0;\n"
...
//            + "       bad_enum a;\n"
    ...
    final static String contextMD =
            ...
            "\n" ;
    @SuppressWarnings("nls")
    static final String callsiteMD =
              "callsite {\n"
            + "    name = \"ust_tests_demo2:loop\";\n"
            + "    func = \"main\";\n" + "    ip = 0x400a29;\n"
            + "    file = \"demo.c\";\n" + "    line = 59;\n" + "};\n" + "\n"
    ...
    static final String simpleTSDL = metadataDecs + ctfStart + ctfHeaders
            + ctfBody;
    static final String enumTSDL = metadataDecs + ctfStart + ctfHeaders
            + ctfBody + enumMd;
    static final String clockTSDL = metadataDecs + clockMD + ctfStart
            + ctfHeaders + ctfBody;
    static final String envTSDL = metadataDecs + environmentMD + ctfStart
            + ctfHeaders + ctfBody;
    static final String contextTSDL = metadataDecs + environmentMD + ctfStart
            + ctfHeaders + ctfBody +contextMD;
    static final String callsiteTSDL = metadataDecs + ctfStart + ctfHeaders
            + ctfBody + callsiteMD;
    static final String allDressedTSDL = metadataDecs + environmentMD + clockMD

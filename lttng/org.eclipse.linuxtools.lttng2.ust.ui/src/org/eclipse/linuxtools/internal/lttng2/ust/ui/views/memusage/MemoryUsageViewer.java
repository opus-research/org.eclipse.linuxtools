...
import org.eclipse.linuxtools.tmf.ui.viewers.xycharts.linecharts.TmfLineChartViewer;
...
public class MemoryUsageViewer extends TmfLineChartViewer {
    ...
    protected void initializeDataSource() {
        if (getTrace() != null) {
            fModule = getTrace().getAnalysisModules(TmfStateSystemAnalysisModule.class).get(UstMemoryAnalysisModule.ID);
            if (fModule == null) {
                return;
            }
            fModule.schedule();

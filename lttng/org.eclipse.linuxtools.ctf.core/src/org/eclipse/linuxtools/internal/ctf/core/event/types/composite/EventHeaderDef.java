...
/**
 * An event header definition, as shown in the example of the CTF spec section
 * 6.1.1
 *
...
public final class EventHeaderDef extends Definition implements ICompositeDefinition {
     ...
     */
    public EventHeaderDef(@NonNull Declaration eventHeaderDecl, long id, long timestamp, int timestampLength) {

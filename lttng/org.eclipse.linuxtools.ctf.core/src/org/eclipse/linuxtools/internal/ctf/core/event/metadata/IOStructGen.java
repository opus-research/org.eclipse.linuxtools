...
public class IOStructGen {
    ...
    private void parseTraceDeclaration(CommonTree traceDecl)
        ...
        if (left.equals(CTFStrings.MAJOR)) {
            ...
            Activator.log(IStatus.WARNING, MessageFormat.format(Messages.IOStructGen_UnknownTraceAttributeWarning, left));
        }
    }
    ...
    private void parseStreamDeclaration(CommonTree streamDecl, Stream stream)
        ...
        if (left.equals(CTFStrings.ID)) {
            ...
            Activator.log(IStatus.WARNING, MessageFormat.format(Messages.IOStructGen_UnknownStreamAttributeWarning, left));
        }
    }
        ...
        for (CommonTree child : children) {
            ...
            case CTFParser.CTF_EXPRESSION_VAL:
                ...
                if (left.equals("signed")) { //$NON-NLS-1$
                    ...
                    Activator.log(IStatus.WARNING, MessageFormat.format(Messages.IOStructGen_UnknownIntegerAttributeWarning, left));
                }

...
public class EnumDeclaration implements IDeclaration {
    ...
    /**
     * Gets a list of values that are guaranteed to be in each enum
     *
     * @return A list of values that are guaranteed to be in each enum, can be
     *         empty but not null
     */
    public List<Long> getAValidValuePerRange() {
    ...
    private class EnumTable {
        ...
        final private List<Range> ranges = new LinkedList<Range>();

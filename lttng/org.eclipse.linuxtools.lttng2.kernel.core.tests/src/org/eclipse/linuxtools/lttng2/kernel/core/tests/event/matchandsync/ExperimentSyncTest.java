...
public class ExperimentSyncTest {
    ...
    @After
    public void cleanUp() {
        fTraces[0].setTimestampTransform(TimestampTransformFactory.getDefault());
        fTraces[1].setTimestampTransform(TimestampTransformFactory.getDefault());
        fTraces[0].dispose();
        fTraces[1].dispose();
    }
    ...
    public void testExperimentSync() {
        try {
            ...
            assertEquals(tt2, TimestampTransformFactory.getDefault());

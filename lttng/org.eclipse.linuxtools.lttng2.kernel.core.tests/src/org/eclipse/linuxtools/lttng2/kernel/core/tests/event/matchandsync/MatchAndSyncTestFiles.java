...
public abstract class MatchAndSyncTestFiles {
     ...
     */
    private final static String traceFile1 = "../org.eclipse.linuxtools.ctf.core.tests/traces/synctraces/scp_src"; //$NON-NLS-1$
    private final static String traceFile2 = "../org.eclipse.linuxtools.ctf.core.tests/traces/synctraces/scp_dest"; //$NON-NLS-1$

    private static CtfTmfTrace fTrace1;
    private static CtfTmfTrace fTrace2;

    /**
     * @return the first kernel trace available
     * @throws TmfTraceException
     *             re-issue exception from trace
     */
    ...
    /**
     * Get a specific trace from this test suite
     *
     * @param traceNo
     *            The trace number
     * @return The requested trace
     * @throws TmfTraceException
     *             re-issue the exception from trace
     */

...
public class StreamListAnalysisTest {
    ...
    public void executeAnalysisTest() throws TmfAnalysisException, TmfTraceException {
        ...
        try (PcapTrace pcapTrace = new PcapTrace();
            ...
            PacketStreamBuilder builder = analysis.getBuilder(Protocol.ETHERNET_II);
            if (builder == null) {
            ...
            builder = analysis.getBuilder(Protocol.IPV4);
            if (builder == null) {
                fail("The PacketStreamBuilder is null!");
                return;
            }
            ...
            builder = analysis.getBuilder(Protocol.TCP);
            if (builder == null) {
                fail("The PacketStreamBuilder is null!");
                return;
            }
            ...
            builder = analysis.getBuilder(Protocol.UDP);
            if (builder == null) {
                fail("The PacketStreamBuilder is null!");
                return;
            }

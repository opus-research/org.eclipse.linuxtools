 ...
 *
 */
class AbstractCustomParserWizard {
     ...
     *            the name of the definition (It's almost always test
     ...
     *             File is not found
     */
    protected static String extractTestXml(File xmlFile, String definitionName) throws IOException, FileNotFoundException {
    ...
    public AbstractCustomParserWizard() {
        super();
    }

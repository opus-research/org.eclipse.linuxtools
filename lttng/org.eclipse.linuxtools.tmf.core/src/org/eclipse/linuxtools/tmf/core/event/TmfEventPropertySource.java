...
public class TmfEventPropertySource implements IPropertySource {
    ...
    private class CustomAttributePropertySource implements IPropertySource {
        ...
        public IPropertyDescriptor[] getPropertyDescriptors() {
            ...
            for(String customAttribute : ((ITmfCustomAttribute)fEvent).listCustomAttributes()) {
        ...
        @Override
        public Object getPropertyValue(Object id) {
            return ((ITmfCustomAttribute)fEvent).getCustomAttribute((String)id);
        }
    ...
    public IPropertyDescriptor[] getPropertyDescriptors() {
        ...
        if((fEvent instanceof ITmfCustomAttribute) && !((ITmfCustomAttribute)fEvent).listCustomAttributes().isEmpty()){
            if(((ITmfCustomAttribute)fEvent).listCustomAttributes().size() != 1) {

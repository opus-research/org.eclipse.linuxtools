...
public abstract class TmfAbstractAnalysisModule extends TmfComponent implements IAnalysisModule {
    ...
    public void setTrace(ITmfTrace trace) throws TmfAnalysisException {
        ...
        if (!appliesToTraceType(trace.getClass())) {
            throw new TmfAnalysisException(NLS.bind(Messages.TmfAbstractAnalysisModule_AnalysisDoesNotApply, getName()));
        }
        if (!canExecute(trace)) {
    ...
    @Override
    public IAnalysisModule getExecutableModule(String id) {
        return null;
    }
    ...
    public void traceOpened(TmfTraceOpenedSignal signal) {
        ...
        /*
         * FIXME: We reach this point usually because the analysis was requested
         * on a trace that is not opened yet but we know its name. But another
         * trace with the same name may exist in another project and reach this
         * point before the trace we really want.
         */
    ...
    public final Bundle getBundle() {
        ...
        if (cl instanceof BundleReference) {
            fBundle = ((BundleReference) cl).getBundle();
        }
        return fBundle;
    }

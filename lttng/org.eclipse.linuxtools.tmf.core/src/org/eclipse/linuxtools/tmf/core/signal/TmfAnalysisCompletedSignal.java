...
/**
 * Signal indicating an analysis has been completed
 */
public class TmfAnalysisCompletedSignal extends TmfSignal {
     ...
     *            The analysis module
     */
    public TmfAnalysisCompletedSignal(Object source, IAnalysisModule module) {
        super(source);
        fModule = module;
    }

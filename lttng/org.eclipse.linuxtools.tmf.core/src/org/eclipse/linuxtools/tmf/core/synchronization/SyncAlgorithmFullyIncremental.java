        ...
        private void approximateSync() {
            ...
            if ((fLmax[0] != null) || (fLmin[0] != null)) {
                ...
                if ((fLmax[0] == null) || (fLmin[0] == null)) {
                    ...
                    /* Debug the hulls */
                    /*
                     * System.out.println("Upper bound"); for (SyncPoint p :
                     * fUpperBoundList) { System.out.println(p.getTimeX() + "\t"
                     * + p.getTimeY()); } System.out.println("Lower bound"); for
                     * (SyncPoint p : fLowerBoundList) {

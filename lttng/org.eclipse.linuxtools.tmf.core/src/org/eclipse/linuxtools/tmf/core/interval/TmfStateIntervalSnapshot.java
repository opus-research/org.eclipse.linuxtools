...
public final class TmfStateIntervalSnapshot {
     ...
     */
    public TmfStateIntervalSnapshot() {
     ...
     */
    public void addIntervals(ITmfStateInterval interval) {
        fList.add(interval);
     ...
     */
    public void addAllIntervals(List<? extends ITmfStateInterval> list) {
     ...
     *             if the attribute key was not found.
     */
    public ITmfStateInterval getInterval(long time, int attribute) throws TimeRangeException, AttributeNotFoundException {
     ...
     */
    public List<ITmfStateInterval> getIntervalList() {

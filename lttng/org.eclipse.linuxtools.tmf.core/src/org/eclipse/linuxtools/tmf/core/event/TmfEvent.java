 ...
 *   Alexandre Montplaisir - Made immutable and abstract
 *******************************************************************************/
...
public abstract class TmfEvent implements ITmfEvent {
    ...
    public String toString() {
        return "TmfEvent [fTimestamp=" + getTimestamp() + ", fTrace=" + getTrace() + ", fRank=" + getRank()
                + ", fSource=" + getSource() + ", fType=" + getType() + ", fContent=" + getContent()
                + ", fReference=" + getReference() + "]";
    }

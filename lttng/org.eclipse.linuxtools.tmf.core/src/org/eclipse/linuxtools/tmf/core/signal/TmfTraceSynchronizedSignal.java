...
/**
 * Signal indicating a trace synchronization has been demanded
 *
 *
 * @author gbastien
 * @since 2.0
...
public class TmfTraceSynchronizedSignal extends TmfSignal {
     ...
     * @param algoSync The synchronization algorithm used
     */
     ...
     */
    SynchronizationAlgorithm getAlgoSync() {
        return fAlgoSync;
    }

    @Override
    public String toString() {
        return "[TmfTraceSynchronizedSignal (" + fAlgoSync.toString() + ")]"; //$NON-NLS-1$ //$NON-NLS-2$
    }

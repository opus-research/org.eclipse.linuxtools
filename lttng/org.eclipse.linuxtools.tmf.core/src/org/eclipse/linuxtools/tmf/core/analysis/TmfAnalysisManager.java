...
public class TmfAnalysisManager {
    ...
    private static Map<String, IAnalysisModule> fAnalysisModules = new HashMap<String, IAnalysisModule>();
     ...
     */
    public static IAnalysisModule getAnalysisModule(ITmfTrace trace, String name) {

...
public interface ITmfTraceIndex {
    ...
    /**
     * Find the checkpoint rank of a checkpoint. Implementors must respect the contract
     * of {@link Collections#binarySearch}
     *
     * @param checkpoint the checkpoint to search for
     * @return the checkpoint rank of the searched checkpoint, if it is contained in the index; otherwise, (-(insertion point) - 1).
     */

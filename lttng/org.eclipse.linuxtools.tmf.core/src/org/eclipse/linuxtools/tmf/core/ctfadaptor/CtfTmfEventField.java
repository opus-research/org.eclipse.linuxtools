...
public abstract class CtfTmfEventField extends TmfEventField {
    ...
    public static CtfTmfEventField parseField(Definition fieldDef,
        ...
        if (fieldDef instanceof IntegerDefinition) {
            ...
            field = new CTFStringField(fieldName, "Unsupported field type: " + fieldDef.getClass().toString()); //$NON-NLS-1$
        }
        return field;
    }
    ...
    /**
     * Prints a numeric value as a string in a given base
     *
     * @param value
     ...
     * @since 2.0
     */
    protected static String formatNumber(long value, int base) {
        String s = ""; //$NON-NLS-1$
...
final class CTFIntegerField extends CtfTmfEventField {
    ...
    public String toString() {
        ...
        sb.append('=');
        sb.append(formatNumber(getValue(), base));

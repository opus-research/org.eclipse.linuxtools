...
final class CTFStructField extends CtfTmfEventField {
     ...
     *            The name of this field
     */
    CTFStructField(String name, ITmfEventField[]  fields) {
        super(name, fields);
    }
    ...
    @Override
    public List<ITmfEventField> getValue() {
        return new ArrayList<ITmfEventField>(Arrays.asList((ITmfEventField[])super.getValue()));
    }
}

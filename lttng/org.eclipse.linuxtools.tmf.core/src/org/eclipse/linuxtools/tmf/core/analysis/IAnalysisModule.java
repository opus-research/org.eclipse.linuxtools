...
public interface IAnalysisModule {
    ...
    /**
     * Get the executable instances of analysis modules provided by this module.
     * Some modules may be [non-executable] entry points to a list of actual
     * modules.
     *
     * For example, an XML analysis module can read from files XML-defined
     * analysis modules.
     *
    ...
    /**
     * Gets a new instance of an executable module with id provided by this
     * module. If the module does not provide executable modules, this method
     * should return null.
     *
     * @param id
     *            The analysis id
     ...
     */
    IAnalysisModule getExecutableModule(String id);

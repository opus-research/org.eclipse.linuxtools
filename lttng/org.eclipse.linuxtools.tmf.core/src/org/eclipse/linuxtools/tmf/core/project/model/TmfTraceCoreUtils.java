...
public class TmfTraceCoreUtils {
    ...
    /**
     * Validates whether the given input string is a valid resource string for
     * one of the given types. It replaces invalid characters by '_' and
     * prefixes the name with '_' if needed.
     *
     * @param input

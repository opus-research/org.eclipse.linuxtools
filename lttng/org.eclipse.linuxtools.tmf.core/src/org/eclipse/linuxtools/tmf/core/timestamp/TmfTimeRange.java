...
/**
 * "Eternity" time range, representing the largest time range possible, which
 * includes any other time range or timestamp.
 */
class EternityTimeRange extends TmfTimeRange {

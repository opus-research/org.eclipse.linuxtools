...
public class TmfCheckpoint implements ITmfCheckpoint {
     ...
     * @param rank the rank of the checkpoint
     * @since 3.0
     */
    public TmfCheckpoint(final ITmfTimestamp timestamp, final ITmfLocation location, long rank) {
    ...
    /**
     * Constructs a checkpoint using also a byte buffer to read the rank from disk.
     *
     * @param timestamp the checkpoint timestamp
     * @param location the corresponding trace location
     * @param bufferIn the byte buffer to read from
     *
     * @since 3.0
     */

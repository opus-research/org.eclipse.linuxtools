...
abstract class Attribute {
    ...
    List<Attribute> getSubAttributes() {
        @SuppressWarnings("null") // subAttributes cannot be null, .unmodifiableList should not be
        @NonNull List<Attribute> ret = Collections.unmodifiableList(subAttributes);
        return ret;
    }
    ...
    String[] getFullAttribute() {
        ...
        @NonNull String[] ret = list.toArray(new String[0]);
        return ret;
    }

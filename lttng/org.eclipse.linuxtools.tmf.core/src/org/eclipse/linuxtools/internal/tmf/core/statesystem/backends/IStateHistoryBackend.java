...
public interface IStateHistoryBackend {
    ...
    /**
     * Complete "give me all interval around the given time" method
     * 'currentStateInfo' is an "out" parameter, that is, write to it the needed
     * information and return. DO NOT 'new' currentStateInfo, it will be lost
     * and nothing will be returned! The result depends of the backend, but
     * return list contains all intervals between startTime and endTime of the
     * stateIntervalList.
     *
     * @param currentStateInfo

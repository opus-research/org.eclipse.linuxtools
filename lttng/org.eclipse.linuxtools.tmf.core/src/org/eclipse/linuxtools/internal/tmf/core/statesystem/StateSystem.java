...
public class StateSystem implements ITmfStateSystemBuilder {
    ...
    public long queryRangeMipmapMax(long t1, long t2, int quark) {
        ...
        try {
            List<ITmfStateInterval> intervals = queryMipmapAttribute(t1, t2, quark, MipMapProvider.MAX_STRING);
    ...
    public long queryRangeMipmapMin(long t1, long t2, int quark) {
        ...
        try {
            List<ITmfStateInterval> intervals = queryMipmapAttribute(t1, t2, quark, MipMapProvider.MIN_STRING);
            for (ITmfStateInterval si : intervals) {
    ...
    public long queryRangeMipmapAverage(long t1, long t2, int quark) {
        double avg = 0;
        try {
            List<ITmfStateInterval> intervals = queryMipmapAttribute(t1, t2, quark, MipMapProvider.AVG_STRING);
            for (ITmfStateInterval si : intervals) {
    ...
    List<ITmfStateInterval> queryMipmapAttribute(long t1, long t2, int quark, String attributeType) {
        ...
        try {
            maxLevelQuark = getQuarkRelative(quark, MipMapProvider.getMimapNbLevelString(attributeType));

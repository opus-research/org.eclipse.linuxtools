...
public final class TmfAnalysisType {
     ...
     */
    public List<TmfAnalysisModuleHelper> getAnalysisModules() {
        List<TmfAnalysisModuleHelper> modules = new ArrayList<TmfAnalysisModuleHelper>();
        for (String moduleId : fAnalysisTypeAttributes.keySet()) {
            IAnalysisModule module = getAnalysisModule(moduleId);
            if (module != null) {
                modules.add(new TmfAnalysisModuleHelper(module));
            }
        }
        return modules;
    }
    ...
    /**
     * Get a new instance of an analysis module
     *
     * @param id
     *            The id of the analysis module
     * @return a new instance of {@link IAnalysisModule}
     */
    public IAnalysisModule getAnalysisModule(String id) {
        IConfigurationElement ce = fAnalysisTypeAttributes.get(id);
        if (ce == null) {
            return null;
        }

...
import org.eclipse.linuxtools.internal.tmf.core.mipmap.AvgMipmapFeature;
import org.eclipse.linuxtools.internal.tmf.core.mipmap.ITmfMipmapFeature;
import org.eclipse.linuxtools.internal.tmf.core.mipmap.MaxMipmapFeature;
import org.eclipse.linuxtools.internal.tmf.core.mipmap.MinMipmapFeature;
...
public abstract class AbstractTmfMipmapStateProvider extends AbstractTmfStateProvider {
    ...
    public void modifyMipmapAttribute(long ts, ITmfStateValue value, int baseQuark, int mipmapFeatureBits, int resolution)
        ...
        if (value.getType() == Type.LONG || value.getType() == Type.INTEGER || value.isNull()) {

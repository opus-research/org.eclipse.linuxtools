...
/**
 * Class for providing selection of current time. It draws a vertical line
 * at the current selected time. The current time can be changed by clicking
 * into the chart or can be set externally. It also notify is viewer about the
 * selection.
 *
 * @since 2.1
 */
public class TmfMouseSelectionProvider extends TmfBaseProvider implements MouseListener, PaintListener {
    ...
    // ------------------------------------------------------------------------
    /**
     * Method sets the current time received from other views or means.
     * It will draw a vertical line on the current position.
     *
     * @param currentTime

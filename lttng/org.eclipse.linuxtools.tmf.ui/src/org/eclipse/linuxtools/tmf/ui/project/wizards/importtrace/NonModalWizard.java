 ...
 * @since 2.0
 */
public class NonModalWizard extends WizardDialog {
     ...
     */
    public NonModalWizard(Shell parentShell, IWizard newWizard) {
    ...
    class HelperThread extends Thread {
        ...
        public HelperThread(IRunnableWithProgress i, SubMonitor s) {
            runnable = i;
            monitor = s;
        }

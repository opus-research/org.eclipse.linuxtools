...
public class TmfNavigatorLabelProvider implements ICommonLabelProvider {
    ...
    public Image getImage(Object element) {
        ...
        if (element instanceof TmfAnalysisView) {
            TmfAnalysisView view = (TmfAnalysisView) element;
            Image icon = view.getIcon();
            if (icon == null) {
        ...
        if (element instanceof TmfTraceAnalysis) {
            TmfTraceAnalysis analysis = (TmfTraceAnalysis) element;
            String iconFile = analysis.getIconFile();
            if (iconFile != null) {
                Image icon = loadIcon(analysis.getBundle(), iconFile);
                return icon;
            }

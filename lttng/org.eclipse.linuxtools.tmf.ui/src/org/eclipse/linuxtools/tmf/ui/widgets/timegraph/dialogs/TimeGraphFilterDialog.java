...
public class TimeGraphFilterDialog extends SelectionStatusDialog {
    ...
    protected Composite createSelectionButtons(Composite composite) {
        ...
        Button selectSelectedButton = createButton(buttonComposite,
                IDialogConstants.ABORT_ID, Messages.TmfTimeFilterDialog_CHECK_SELECTED,
                false);
        listener = new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
        ...
        selectSelectedButton.addSelectionListener(listener);

        Button deselectSelectedButton = createButton(buttonComposite,
                IDialogConstants.ABORT_ID, Messages.TmfTimeFilterDialog_UNCHECK_SELECTED,
                false);
        listener = new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
        ...
        deselectSelectedButton.addSelectionListener(listener);

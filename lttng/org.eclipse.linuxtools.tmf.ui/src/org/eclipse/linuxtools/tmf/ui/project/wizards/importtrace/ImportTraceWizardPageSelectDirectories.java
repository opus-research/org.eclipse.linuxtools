...
/**
 * Select the directories to scan for traces. (2/4)
 *
...
public class ImportTraceWizardPageSelectDirectories extends AbstractImportTraceWizardPage {
    ...
    public void createControl(Composite parent) {
        ...
        addFile.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                // FileDialog(Display.getCurrent().getActiveShell(), SWT.OPEN | SWT.MULTI);
        ...
        removeFile.addSelectionListener(new SelectionListener() {
        ...
        this.setTitle("Pick directories and files to scan");
    }

    protected void updateButtons() {
        BatchImportTraceWizard wiz = getBatchWizard();
        ImportUtils.buildFilesToScan(wiz);
        updateTable();
    ...
    public boolean canFlipToNextPage() {
        final boolean hasAtLeastOneFileToScan = !((BatchImportTraceWizard) getWizard()).getFilesToScan().isEmpty();
        if( hasAtLeastOneFileToScan ){
            setErrorMessage(null);
        } else {
            setErrorMessage("Select at least one directory to scan");
        }
        return hasAtLeastOneFileToScan;
    }

...
/**
 * Time Event implementation specific to the Execution Stack View
 *
...
public class CallStackEvent extends TimeEvent {
    ...
    public String toString() {
        return "CallStackEvent start=" + fTime + " end=" + (fTime + fDuration) + " duration=" + fDuration + " value=" + fValue; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    }
}

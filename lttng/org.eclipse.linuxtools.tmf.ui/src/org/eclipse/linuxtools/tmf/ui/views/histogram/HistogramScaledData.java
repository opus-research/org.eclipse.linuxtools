...
public class HistogramScaledData {
     ...
     * @since 3.0
     */
    public static boolean showLostEvents = false;
    // ------------------------------------------------------------------------
    // Constructor
    // ------------------------------------------------------------------------
    ...
    public HistogramScaledData(HistogramScaledData other) {
        ...
        fLostEventsData  = Arrays.copyOf(other.fLostEventsData, fWidth);

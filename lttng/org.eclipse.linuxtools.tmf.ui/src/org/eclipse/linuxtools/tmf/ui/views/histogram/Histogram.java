...
public abstract class Histogram implements ControlListener, PaintListener, KeyListener, MouseListener, MouseTrackListener, IHistogramModelListener {
    ...
    public void removeMouseWheelListener(MouseWheelListener listener) {
        ...
        fMaxNbEventsText.removeMouseWheelListener(listener);
        fMinNbEventsText.removeMouseWheelListener(listener);
        fTimeRangeStartText.removeMouseWheelListener(listener);
        fTimeRangeEndText.removeMouseWheelListener(listener);
    }

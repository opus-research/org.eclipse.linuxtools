...
import org.eclipse.linuxtools.tmf.ui.widgets.timegraph.widgets.TimeDataProviderCyclesWrapper;
...
public class TimeGraphViewer implements ITimeDataProvider, SelectionListener {
    ...
    public void setTimeFormat(TimeFormat tf) {
        ...
        if (tf == TimeFormat.CYCLES) {
            fTimeDataProvider = new TimeDataProviderCyclesWrapper(this, fClockFrequency);
        } else {

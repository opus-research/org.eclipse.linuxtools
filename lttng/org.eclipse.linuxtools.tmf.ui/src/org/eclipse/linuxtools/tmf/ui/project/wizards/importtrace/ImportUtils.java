...
final public class ImportUtils {
    ...
    public boolean validate(String traceTypeName, String fileName) {
        ...
        return validateTraceFiles(traceTypeName, fileList);
    }
     ...
     * @param selectedResources List of traces to validate
     ...
     * @param traceTypeName
     *            the trace category (canonical name)
     * @param traces the list of files to check if they are trace
     * @return true if all the traces are valid
     */

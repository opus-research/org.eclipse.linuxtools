 ...
 *
 */
public class TimeDataProviderCyclesWrapper implements ITimeDataProviderWrapper {

    private @NonNull ITimeDataProvider fProvider;
     ...
     */
    public TimeDataProviderCyclesWrapper(@NonNull ITimeDataProvider provider, long clockFrequency) {
        fProvider = provider;
    ...
    public long toCycles(long nanos) {
        return Math.round(nanos * ((double) fFreq / 1000000000L));
    }
    ...
    public long toNanos(long cycles) {
        return Math.round(cycles * ((double) 1000000000L / fFreq));
    }

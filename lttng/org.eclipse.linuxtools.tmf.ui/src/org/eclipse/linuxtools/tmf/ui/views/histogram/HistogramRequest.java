...
import org.eclipse.linuxtools.tmf.core.ctfadaptor.CtfTmfLostEvent;
...
public class HistogramRequest extends TmfEventRequest {
    ...
    public void handleData(ITmfEvent event) {
        ...
        if (event != null) {
            if (!(event instanceof CtfTmfLostEvent)) {
                ...
                CtfTmfLostEvent lostEvents = (CtfTmfLostEvent) event;
                /* clear the old data when it is a new request */
                fHistogram.countLostEvent(lostEvents.getTimeRange(), (int) lostEvents.getNbLostEvents(), fFullRange);
            }
        }
    }

...
public abstract class TmfViewer extends TmfComponent implements ITmfViewer {
    ...
    /**
     * Empty constructor.
     * The viewer have to be initialize through the {@link TmfViewer#init(Composite, String)} function later on.
     */
    public TmfViewer() {
        super();
    }
    ...
    /**
     * Default constructor that initialize the parent of the viewer
     *
     * @param parent The parent composite that holds this viewer
     *
    ...
    /**
     * Constructor that initialize the parent of the viewer and that sets the name of the viewer
     *
     * @param parent The parent composite that holds this viewer
    ...
    /**
     * Performs initialization of the viewer. It initializes the component.
     * Need to be called when the default constructor is used.
     *
     * @param parent The parent composite of the viewer
     * @param name The name to give to this viewer

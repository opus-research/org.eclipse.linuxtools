...
import org.eclipse.linuxtools.tmf.ui.widgets.tabsview.TmfTabsView;
...
public class TmfStatisticsView extends TmfView {
     ...
     */
    private TmfTabsView<ITmfStatisticsViewer> fStatsViewers;
    /**
     ...
     */
    protected TmfTabsView<ITmfStatisticsViewer> createStatisticsViewers() {
        // Default style for the tabs that will be created
        int defaultStyle = SWT.NONE;

        // Create the list of statistics viewer.
        TmfTabsView<ITmfStatisticsViewer> tabsView = new TmfTabsView<ITmfStatisticsViewer>(fParent);

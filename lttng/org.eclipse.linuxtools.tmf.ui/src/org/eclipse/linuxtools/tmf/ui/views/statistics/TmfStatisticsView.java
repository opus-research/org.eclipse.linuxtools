...
public class TmfStatisticsView extends TmfView {
    ...
    public TmfStatisticsView(String viewName) {
        super(viewName);
        /*
         * Invisible composite to use as the parent of the viewer folder, since
         * a parent composite cannot be null. The real parent is set in createPartControl.
         */
        Shell shell = new Shell();
        fStatsViewers = new TmfViewerFolder(shell);
    }
    ...
    public void createPartControl(Composite parent) {
        fParent = parent;
        fStatsViewers.setParent(fParent);
     ...
     * insert it in the viewer folder. Each viewer is placed in a different tab
     * and the first one is selected automatically.
     *
     * It uses the extension point that defines the statistics viewer to build
     * from the trace type. If no viewer is defined for the trace type, no
     * viewer will be created, since the global viewer gives the basic
     * information for all traces in the experiment. If the experiment is empty,
     * a global statistics viewer will still be created.
     *
     * @since 2.0
     */
     ...
     */
    private static TmfStatisticsViewer getStatisticsViewer(IResource resource) {

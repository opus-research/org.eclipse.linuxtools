...
public abstract class AbstractTimeGraphView extends TmfView {
     ...
     */
    protected int getSelectionValue(long time) {
        return 0;
    }

    /**
     * Selects an entry in the time graph view
     *
     * @param value
     *            The value returned by getSelectionValue to identify the entry
     *            to select
     */
    protected void selectEntry(int value) {
        /*
         * Override to use the value obtained in getSelectionValue to select an
         * entry
         */
    }
    ...
    public void synchToTime(final TmfTimeSynchSignal signal) {
        ...
        /*
         * Get some value identifying the selected entry, selection will be
         * processed in the asyncExec call
         */
        final int selectionValue = getSelectionValue(time);

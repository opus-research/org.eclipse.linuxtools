...
public abstract class AbstractTimeGraphView extends TmfView {
    ...
    /** A comparator class */
    private final Comparator<ITimeGraphEntry> fEntryComparator;
     ...
     * @param comparator
     *            Object used to compare entries (default null)
     */
    public AbstractTimeGraphView(String id, String[] cols, String[] filterCols,
            TimeGraphPresentationProvider pres, Comparator<ITimeGraphEntry> comparator) {
        super(id);
        fColumns = cols;

 ...
 */
class TmfStatisticsRequest extends TmfEventRequest<ITmfEvent> {
     ...
     * Constructor
     *
     * @param sender Sender of this request
     * @param experiment Experiment targeted by this request
     * @param range The target time range
     * @param index The starting index
     * @param prio The priority of the request
     * @param global Is this for a global statistics request (true), or a partial one (false)?
     */
    ...
    public void handleCancel() {
        super.handleCancel();
        // The global request can be canceled when another experiment is selected, but a time range request can also be
        // canceled when there is a time range update which means the model must not be deleted.
        if (fGlobal) {
            fSender.modelIncomplete(fExperiment.getName());
        }
    }

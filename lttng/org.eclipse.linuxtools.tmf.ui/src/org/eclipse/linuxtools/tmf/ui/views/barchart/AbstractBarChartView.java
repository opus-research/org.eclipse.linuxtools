...
public abstract class AbstractBarChartView extends TmfView {
    ...
    public AbstractBarChartView(String id, String[] cols, String[] filterCols,
        ...
        this(id, cols, filterCols, pres, new BarChartEntryComparator());
    }
...
//                }
     ...
     *
     * @param trace The trace being built
     * @param monitor The progress monitor object
     */
     ...
     *
     * @param entry The entry to get events for

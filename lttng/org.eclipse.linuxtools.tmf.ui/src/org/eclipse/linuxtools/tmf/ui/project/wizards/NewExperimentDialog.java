...
public class NewExperimentDialog extends SelectionStatusDialog {
    ...
    private static final String DEFAULT_TRACE_TYPE = "org.eclipse.linuxtools.tmf.ui.experimenttype.generic"; //$NON-NLS-1$
        ...
        WorkspaceModifyOperation operation = new WorkspaceModifyOperation() {
            ...
            public void execute(IProgressMonitor monitor) throws CoreException {
                try {
                    ...
                    /*
                     * Experiments can be set to the default trace type. No need
                     * to force user to select an experiment type
                     */
                    IConfigurationElement ce = TmfTraceType.getInstance().getTraceAttributes(DEFAULT_TRACE_TYPE);
                    if (ce != null) {
                        try {

...
/**
 * This class allows a trace type to specify which additional columns it want to
 * display in the Event Table. The "function" to populate the column for any
 * given event is defined in each {@link TmfEventTableColumn}.
 *
...
public interface ITmfEventTableColumns {
     ...
     * is called.
     *
     * @return The Event Table columns specific to this trace type
     */
    Collection<? extends TmfEventTableColumn> getEventTableColumns();
}

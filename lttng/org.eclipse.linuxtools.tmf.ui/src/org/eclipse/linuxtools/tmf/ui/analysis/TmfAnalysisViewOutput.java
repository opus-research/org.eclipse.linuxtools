...
public class TmfAnalysisViewOutput implements IAnalysisOutput {
    ...
    @Override
    public void requestOutput(IAnalysisModule module) {
        Display.getDefault().asyncExec(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    TraceUtils.displayErrorMsg(Messages.TmfTraceElement_Title, "Error opening view " + getName() + e.getMessage()); //$NON-NLS-1$

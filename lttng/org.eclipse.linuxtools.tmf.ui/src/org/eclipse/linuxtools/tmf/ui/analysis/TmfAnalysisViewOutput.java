...
/**
 * Class that implements analysis output as a view
 * @since 3.0
 */
public class TmfAnalysisViewOutput implements IAnalysisOutput {
    ...
    public String getName() {
        ...
        String viewName = (descr != null) ? descr.getLabel() : fViewId + Messages.TmfTraceAnalysis_ViewUnavailable;
        return viewName;
    }

    @Override
    public void outputAnalysis(IAnalysisModule module) {
        Display.getDefault().asyncExec(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    displayErrorMsg("Error opening view " + getName() + e.getMessage()); //$NON-NLS-1$

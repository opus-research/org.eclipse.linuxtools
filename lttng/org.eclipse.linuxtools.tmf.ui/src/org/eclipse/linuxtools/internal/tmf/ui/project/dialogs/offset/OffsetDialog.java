...
public class OffsetDialog extends Dialog {
    ...
    private void createMessageArea(final Composite parent) {
        ...
        fMessageLabel.setText(Messages.OffsetDialog_AdvancedMessage);
    ...
    private void createButtonGroup(final Composite parent) {
        ...
        final Button basicButton = new Button(group, SWT.RADIO);
        ...
        basicButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                fMessageLabel.setText(Messages.OffsetDialog_BasicMessage);
                parent.layout();
            }
        });

        final Button advancedButton = new Button(group, SWT.RADIO);
        ...
        advancedButton.setSelection(true);
    }

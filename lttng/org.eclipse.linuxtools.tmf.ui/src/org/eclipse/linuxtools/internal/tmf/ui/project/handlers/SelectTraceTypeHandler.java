 ...
 *   Bernd Hufmann - Move propagation of persistent properties to Utility Class
 *******************************************************************************/
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        for (Object element : fSelection.toList()) {
            ...
            if (resource != null) {
                ...
                IStatus status = TraceTypeUtil.propagateProperties(trace, bundleName, traceType, iconUrl);
                ok &= status.isOK();
                if (!status.isOK()) {
                    statuses.add(status);
                }

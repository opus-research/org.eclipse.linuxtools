...
import org.eclipse.linuxtools.internal.tmf.ui.project.wizards.offset.OffsetWizard;
            ...
            public void run() {
                ...
                Display.getDefault().asyncExec(new Runnable() {
                    ...
                    public void run() {
                        ...
                        OffsetWizard od = new OffsetWizard(transforms);

                        WizardDialog wd40 = new WizardDialog(window.getShell(), od);
                        wd40.open();

 ...
 *
 * Contributors:
 *   Bernd Hufmann - Extracted main implementation to this base class
 *******************************************************************************/
 ...
 */
public abstract class BaseTraceTypeContributionItem extends CompoundContributionItem {
    ...
    private void addContributionItem(List<IContributionItem> list,
        ...
        params.put(TraceTypeUtil.BUNDLE_PARAMETER, traceBundle);
        params.put(TraceTypeUtil.TYPE_PARAMETER, traceTypeId);
        params.put(TraceTypeUtil.ICON_PARAMETER, traceIcon);
    ...
    /**
     * @return the command Id that this contribution item handles.
     */

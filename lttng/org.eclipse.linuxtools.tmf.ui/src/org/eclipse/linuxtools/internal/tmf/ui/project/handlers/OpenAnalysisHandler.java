...
import org.eclipse.linuxtools.tmf.ui.project.model.TmfTraceAnalysis;
...
public class OpenAnalysisHandler extends AbstractHandler {
    ...
    public boolean isEnabled() {
        ...
        if (selection instanceof TreeSelection) {
            ...
            if (element instanceof TmfTraceAnalysis) {
                fAnalysis = (TmfTraceAnalysis) element;
            }
        }
    ...
    private static void displayHelpMsg(final String errorMsg) {
        Display.getDefault().asyncExec(new Runnable() {
            ...
            public void run() {
                /*
                 * TODO: A message box is not the best place to show help. But

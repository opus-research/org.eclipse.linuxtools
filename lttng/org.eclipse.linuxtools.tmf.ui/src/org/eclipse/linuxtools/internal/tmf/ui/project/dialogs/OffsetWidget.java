...
public class OffsetWidget {
    ...
    private final OffsetDialog fParent;
    private final @NonNull ITmfTrace fTrace;
    private Composite fPadre;
     ...
     *            the trace
     */
    public OffsetWidget(@NonNull OffsetDialog offsetDialog, @NonNull ITmfTrace tmfTrace) {
        fParent = offsetDialog;
        fTrace = tmfTrace;

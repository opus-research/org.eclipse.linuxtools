...
public class ControlPreferences {
     ...
     */
    public static final String TRACE_CONTROL_COMMAND_TIMEOUT_PREF = "trace.control.command.timout"; //$NON-NLS-1$
    /**
     ...
     */
    public final static int TRACE_CONTROL_MIN_TIMEOUT_VALUE = 10;
    /**

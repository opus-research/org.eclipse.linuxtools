...
final public class TraceControlDialogFactory {
    ...
    /**
     * the enable consumer dialog
     */
    private IEnableConsumerDialog fEnableConsumerDialog;
     ...
     * @return create session dialog implementation
     */
    public IEnableConsumerDialog getEnableConsumerDialog() {
        if (fEnableConsumerDialog == null) {
            fEnableConsumerDialog = new EnableConsumerDialog(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell());
        }
        return fEnableConsumerDialog;
    }

...
public class StateValueCompareToTest {
    ...
    private static final ITmfStateValue baseIntValue = TmfStateValue.newValueInt(10);
    private static final ITmfStateValue biggerIntValue = TmfStateValue.newValueInt(20);
    private static final ITmfStateValue smallerIntValue = TmfStateValue.newValueInt(6);

    private static final ITmfStateValue baseLongValue = TmfStateValue.newValueLong(10);
    private static final ITmfStateValue biggerLongValue = TmfStateValue.newValueLong(20);
    private static final ITmfStateValue smallerLongValue = TmfStateValue.newValueLong(6);
    private static final ITmfStateValue minLongValue = TmfStateValue.newValueLong(Long.MIN_VALUE);
    private static final ITmfStateValue maxLongValue = TmfStateValue.newValueLong(Long.MAX_VALUE);

    private static final ITmfStateValue baseDoubleValue = TmfStateValue.newValueDouble(10.00);
    private static final ITmfStateValue biggerDoubleValue1 = TmfStateValue.newValueDouble(20.00);
    private static final ITmfStateValue biggerDoubleValue2 = TmfStateValue.newValueDouble(10.03);
    private static final ITmfStateValue smallerDoubleValue1 = TmfStateValue.newValueDouble(6.00);
    private static final ITmfStateValue smallerDoubleValue2 = TmfStateValue.newValueDouble(9.99);
    private static final ITmfStateValue minDoubleValue = TmfStateValue.newValueDouble(Double.MIN_VALUE);
    private static final ITmfStateValue maxDoubleValue = TmfStateValue.newValueDouble(Double.MAX_VALUE);
    private static final ITmfStateValue positiveInfinity = TmfStateValue.newValueDouble(Double.POSITIVE_INFINITY);
    private static final ITmfStateValue negativeInfinity = TmfStateValue.newValueDouble(Double.NEGATIVE_INFINITY);

    private static final ITmfStateValue baseStringValue = TmfStateValue.newValueString("D");
    private static final ITmfStateValue biggerStringValue = TmfStateValue.newValueString("Z");
    private static final ITmfStateValue smallerStringValue = TmfStateValue.newValueString("A");

    private static final ITmfStateValue nullValue = TmfStateValue.nullValue();

    /**
     * Test that the {@link ITmfStateValue#compareTo(ITmfStateValue)} method
     * compares correctly the different state values
     *
     */
    @Test

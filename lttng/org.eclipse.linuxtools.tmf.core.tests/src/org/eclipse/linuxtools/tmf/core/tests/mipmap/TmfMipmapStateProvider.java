 ...
 * @since 3.0
 */
public class TmfMipmapStateProvider extends AbstractTmfMipmapStateProvider {
    /** test attribute name */
     ...
     */
    public TmfMipmapStateProvider(int resolution, Type type) {
    ...
    @Override
    public TmfMipmapStateProvider getNewInstance() {
        return new TmfMipmapStateProvider(resolution, type);
    }

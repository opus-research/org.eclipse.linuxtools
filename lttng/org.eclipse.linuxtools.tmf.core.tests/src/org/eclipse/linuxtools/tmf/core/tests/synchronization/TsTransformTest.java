...
public class TsTransformTest {
    ...
    public void testEquality() {
        ...
        ITmfTimestampTransform ttl = new TmfTimestampTransformLinear(null, null, BigDecimal.valueOf(2.0), BigDecimal.valueOf(3));
        ITmfTimestampTransform ttl2 = new TmfTimestampTransformLinear(null, null, BigDecimal.valueOf(2.0), BigDecimal.valueOf(3));
        ITmfTimestampTransform ttl3 = new TmfTimestampTransformLinear(null, null, BigDecimal.valueOf(3), BigDecimal.valueOf(3));

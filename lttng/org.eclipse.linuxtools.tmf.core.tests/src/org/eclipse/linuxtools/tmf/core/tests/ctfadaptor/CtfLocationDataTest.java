...
public class CtfLocationDataTest {
    ...
    /**
     * Test for the .getTimestamp() and .getOffset() methods
     */
    @Test
    public void testGetters() {
        long timestamp = fixture.getTimestamp();
        long offset = fixture.getOffset();
    ...
    public void testEquals() {
        ...
        CtfLocationData diff = new CtfLocationData(1, 10);

        assertTrue(fixture.equals(same));
        assertFalse(fixture.equals(diff));
    }
    ...
    public void testCompareTo() {
        CtfLocationData same = new CtfLocationData(1, 0);
        CtfLocationData same2 = new CtfLocationData(5, -4);
        CtfLocationData smaller = new CtfLocationData(0, 0);
        CtfLocationData bigger = new CtfLocationData(1000, 500);

        assertEquals(0, same.compareTo(fixture));
        assertEquals(0, same2.compareTo(fixture));
        assertEquals(-1, smaller.compareTo(fixture));
        assertEquals(1, bigger.compareTo(fixture));
    }

...
public class CtfTmfMipMapStateProviderForTest extends AbstractTmfMipMapStateProvider {
     ...
     */
    public CtfTmfMipMapStateProviderForTest(CtfTmfTrace trace, int resolution[]) {
        super(trace, CtfTmfEvent.class, CTF_MIPMAP_ID, false);
        this.knownEventNames = fillEventNames();
    ...
    protected void eventHandle(ITmfEvent ev) {
        ...
        if (ev instanceof CtfTmfEvent)
        {
            ...
            case 2:
                ...
                computeMipmapAttribute(ts, value, quark, AbstractTmfMipMapStateProvider.MAX_STRING, resolution[0]);
                computeMipmapAttribute(ts, value, quark, AbstractTmfMipMapStateProvider.MIN_STRING, resolution[1]);
                computeMipmapAttribute(ts, value, quark, AbstractTmfMipMapStateProvider.AVG_STRING, resolution[2]);
    ...
    @Override
    public void dispose() {
        closeMipMap(AbstractTmfMipMapStateProvider.MAX_STRING);
        closeMipMap(AbstractTmfMipMapStateProvider.MIN_STRING);
        closeMipMap(AbstractTmfMipMapStateProvider.AVG_STRING);
        super.dispose();
    }
    @Override

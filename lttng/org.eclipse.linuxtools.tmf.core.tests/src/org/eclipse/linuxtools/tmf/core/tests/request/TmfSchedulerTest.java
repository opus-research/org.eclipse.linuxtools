...
public class TmfSchedulerTest {
    ...
    public void TestMultiRequest6() {
        ...
        /*
         * One background and one foreground request for the entire trace, one
         * foreground request to select an event
         */
    ...
    public void preemptedForegroundRequest() {
        // TODO Comment avoir le thread créé par le signal ? Simuler ma request
        // !
        ...
        /*
         * TmfTimeSynchSignal signal7 = new TmfTimeSynchSignal(this, new
         * TmfTimestamp(startTime + ((endTime - startTime) / 8)));
         * fTimeSyncThrottle.queue(signal7);
         */

...
public class PairTest {
    ...
    Pair<String, Long> fPair1 = new Pair<String, Long>("String 1", Long.valueOf(1L));
    Pair<String, Long> fPair2 = new Pair<String, Long>("String 2", Long.valueOf(2L));
    ...
    public void testAccessors() {
        Pair<String, Long> myPair = new Pair<String, Long>("String 1", Long.valueOf(1L));
        ...
        myPair.setSecond(Long.valueOf(123L));
    ...
    public void testEqualsSymmetry() {
        Pair<String, Long> info1 = new Pair<String, Long>(fPair1.getFirst(), fPair1.getSecond());
        Pair<String, Long> info2 = new Pair<String, Long>(fPair2.getFirst(), fPair2.getSecond());
    ...
    public void testEqualsTransivity() {
        Pair<String, Long> info1 = new Pair<String, Long>(fPair1.getFirst(), fPair1.getSecond());
        Pair<String, Long> info2 = new Pair<String, Long>(fPair1.getFirst(), fPair1.getSecond());
        Pair<String, Long> info3 = new Pair<String, Long>(fPair1.getFirst(), fPair1.getSecond());
    ...
    public void testEqualsDifferentObj() {
        Pair<Long, String> info = new Pair<Long, String>(Long.valueOf(1L), "String1");

...
package org.eclipse.linuxtools.tmf.core.tests.ctfadaptor.headless.helper;
 ...
 * @since 3.0
 */
public class CtfMipMapProviderForTest extends AbstractTmfMipmapStateProvider {
    ...
    protected void eventHandle(ITmfEvent ev) {
        ...
        if (ev instanceof CtfTmfEvent)
        {
            ...
            case 2:
                ...
                modifyMipmapAttribute(ts, value, quark, AbstractTmfMipmapStateProvider.MAX, resolution[0]);
                modifyMipmapAttribute(ts, value, quark, AbstractTmfMipmapStateProvider.MIN, resolution[1]);
                modifyMipmapAttribute(ts, value, quark, AbstractTmfMipmapStateProvider.AVG, resolution[2]);

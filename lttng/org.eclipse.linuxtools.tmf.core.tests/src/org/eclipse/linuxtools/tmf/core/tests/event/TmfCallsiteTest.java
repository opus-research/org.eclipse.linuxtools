...
public class TmfCallsiteTest {
    ...
    public void testNullElements() {
        ITmfCallsite callsite = new TmfCallsite(null, fFunctionName1, fLine1);
        assertFalse("equals", fCallsite1.equals(callsite));
        assertFalse("equals", callsite.equals(fCallsite1));

        callsite = new TmfCallsite(fFileName1, null, fLine1);
        assertFalse("equals", fCallsite1.equals(callsite));
        assertFalse("equals", callsite.equals(fCallsite1));
    }
    ...
    public void testToString() {
        ...
        ITmfCallsite callsite = new TmfCallsite(null, fFunctionName1, fLine1);
        assertEquals("toString", ":10 func1()", callsite.toString());
    }
}

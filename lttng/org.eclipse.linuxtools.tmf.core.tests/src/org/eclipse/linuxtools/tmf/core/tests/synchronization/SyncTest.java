...
public class SyncTest {
    ...
    public void testFullyIncremental() {
        ...
        assertEquals(Messages.SyncAlgorithmFullyIncremental_absent, syncAlgo.getStats().get("t1 <==> t2").get(Messages.SyncAlgorithmFullyIncremental_quality));
        syncAlgo.addMatch(
        ...
        assertEquals(Messages.SyncAlgorithmFullyIncremental_incomplete, syncAlgo.getStats().get("t1 <==> t2").get(Messages.SyncAlgorithmFullyIncremental_quality));
        ...
        assertEquals(Messages.SyncAlgorithmFullyIncremental_approx, syncAlgo.getStats().get("t1 <==> t2").get(Messages.SyncAlgorithmFullyIncremental_quality));
        ...
        assertEquals(Messages.SyncAlgorithmFullyIncremental_accurate, syncAlgo.getStats().get("t1 <==> t2").get(Messages.SyncAlgorithmFullyIncremental_quality));
        ...
        assertEquals(Messages.SyncAlgorithmFullyIncremental_fail, syncAlgo.getStats().get("t1 <==> t2").get(Messages.SyncAlgorithmFullyIncremental_quality));
    }

...
package org.eclipse.linuxtools.tmf.analysis.xml.tests;
...
/**
 * Test the Xml Analysis plug-in activator
 */
public class XmlAnalysisPluginTest {
    // ------------------------------------------------------------------------
    // Attributes
    // ------------------------------------------------------------------------
    ...
    public void testTmfCorePluginId() {
        assertEquals("Plugin ID", "org.eclipse.linuxtools.tmf.analysis.xml", Activator.PLUGIN_ID);
    }

...
/**
 * Example handler for opening the example wizard
 */
public class MyImportTraceHandler extends AbstractHandler {

    @Override
    public Object execute(ExecutionEvent event) throws ExecutionException {
        MyImportTraceWizard w = new MyImportTraceWizard();
        ...
        // Only use the selection if handler is called from context-sensitive
        // menu

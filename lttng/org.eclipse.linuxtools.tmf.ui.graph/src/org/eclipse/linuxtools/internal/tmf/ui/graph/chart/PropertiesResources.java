package org.eclipse.linuxtools.internal.tmf.ui.graph.chart;
...
public class PropertiesResources {
    ...
    /**
     * Puts the given font. If a font associated with the given key already exists, the existing font will be disposed.
     * When chart is disposed, all stored fonts in this object will be disposed.
     * <p>
    ...
    /**
     * Puts the given color. If a font associated with the given key already exists, the existing color will be
     * disposed. When chart is disposed, all stored colors in this object will be disposed.
     * 
     * @param key
    ...
    /**
     * Removes the font associated with the given key. This method will be invoked typically when removing series object
     * or axis object.
     * 
     * @param key
    ...
    /**
     * Removes the color associated with the given key. This method will be invoked typically when removing series
     * object or axis object.
     * 
     * @param key

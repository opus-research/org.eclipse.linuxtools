...
public class ImportAndReadSmokeTest {
     ...
     */
    @BeforeClass
    public static void init() throws WorkbenchException {
        /*
         * set up for swtbot
         */
         ...
         * Switch perspectives
         */
        switchPerspective("org.eclipse.linuxtools.lttng2.kernel.ui.perspective");
        /*
    ...
    private static void switchPerspective(String perspectiveID) throws WorkbenchException {
        {
            workbench = PlatformUI.getWorkbench();
            IPerspectiveDescriptor x = workbench.getPerspectiveRegistry().findPerspectiveWithId(perspectiveID);
    ...
    private static void createProject() throws InterruptedException {
        ...
        Job j = new Job("Create Project") {
            ...
            private void newProject(IProgressMonitor monitor) {
                ...
                final SWTBotTreeItem tracingNode = tree.expandNode("Tracing");

                keyEvent(tree, SWT.PAGE_DOWN);
                tracingNode.select();
                monitor.worked(20);
                final SWTBotTreeItem tracingProject = tracingNode.getNode(0);
                assertNotNull(tracingProject);

                tracingProject.select();
                tracingProject.click(1);

...
public class CustomXmlIndexTest {
    ...
    private class TestTrace extends CustomXmlTrace {
        public TestTrace(String path, CustomXmlTraceDefinition createDefinition, int blockSize) throws TmfTraceException {

...
public class ResourcesView extends AbstractBarChartView {
    ...
    /** View ID. */
    public static final String RESID = "org.eclipse.linuxtools.lttng2.kernel.ui.views.newres"; //$NON-NLS-1$
    ...
    public ResourcesView() {
        super(RESID, COLUMN_NAMES, FILTER_COLUMN_NAMES, new ResourcesPresentationProvider());
    ...
    protected void buildEventList(ITmfTrace trace, IProgressMonitor monitor) {
        ...
        for (ITmfTrace aTrace : trace.getTraces()) {
            ...
            if (aTrace instanceof CtfKernelTrace) {
                ...
                ResourcesEntry groupEntry = new ResourcesEntryNull(ctfKernelTrace, aTrace.getName(), startTime, endTime, 0);
                ...
                for (int i = 0; i < cpuQuarks.size(); i++) {
                    ...
                    ResourcesEntry entry = new ResourcesEntryCpu(cpuQuark, ctfKernelTrace, fStartTime, fEndTime, cpu);
                ...
                for (int i = 0; i < irqQuarks.size(); i++) {
                    ...
                    ResourcesEntry entry = new ResourcesEntryIrq(irqQuark, ctfKernelTrace, fStartTime, fEndTime, irq);
                    groupEntry.addChild(entry);
                    irqEntries[i] = entry;
                }
                ...
                for (int i = 0; i < softIrqQuarks.size(); i++) {
                    ...
                    ResourcesEntry entry = new ResourcesEntrySoftirq(softIrqQuark, ctfKernelTrace, fStartTime, fEndTime, softIrq);
                    groupEntry.addChild(entry);

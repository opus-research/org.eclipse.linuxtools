...
final class ResourcesEntryNull extends ResourcesEntry {
    ...
    public ResourcesEntryNull(CtfKernelTrace trace, String name, long startTime, long endTime, int id) {
...
final class ResourcesEntryCpu extends ResourcesEntry {
    ...
    public ResourcesEntryCpu(int quark, CtfKernelTrace trace, long startTime, long endTime, int id) {

...
public class ControlFlowView extends AbstractTimeGraphView {
    ...
    public ControlFlowView() {
        super(ID, COLUMN_NAMES, FILTER_COLUMN_NAMES, new ControlFlowPresentationProvider(), new ControlFlowEntryComparator());
    ...
    protected static class ControlFlowTreeLabelProvider extends TreeLabelProvider {
        ...
        private static final int TID_COL = 1;
        private static final int PTID_COL = 2;
        private static final int START_COL = 3;
        private static final int TRACE_COL = 4;

...
public class ControlFlowView extends AbstractTimeGraphView {
    ...
    public ControlFlowView() {
        ...
        setTreeLabelProvider(new CfvTreeLabelProvider());
     ...
     *
     */
    protected static class CfvTreeLabelProvider extends TreeLabelProvider {
            ...
            if (aTrace instanceof LttngKernelTrace) {
                ...
                for (int threadQuark : threadQuarks) {
                    ...
                    try {
                        ...
                        List<ITmfStateInterval> execNameIntervals = ssq.queryHistoryRange(execNameQuark, start, end - 1); // use
                                                                                                                          // monitor
                                                                                                                          // when
                                                                                                                          // available
                                                                                                                          // in
    ...
    protected List<ITimeEvent> getEventList(TimeGraphEntry entry, long startTime, long endTime, long resolution, IProgressMonitor monitor) {
        ...
        try {
            int statusQuark = ssq.getQuarkRelative(entry.getEntryId(), Attributes.STATUS);

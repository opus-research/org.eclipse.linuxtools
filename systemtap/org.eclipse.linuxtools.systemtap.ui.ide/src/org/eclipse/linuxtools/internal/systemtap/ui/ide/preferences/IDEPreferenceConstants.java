...
public class IDEPreferenceConstants {
	...
	public static final String[][] STAP_STRING_OPTIONS = new String[][] {
		...
		{"-x", "target PID", "xStapPreference", "sets target() to the given PID. This allows scripts to be written that filter on a specific process."}}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

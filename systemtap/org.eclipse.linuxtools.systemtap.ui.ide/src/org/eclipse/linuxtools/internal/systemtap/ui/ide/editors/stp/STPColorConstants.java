...
public interface STPColorConstants {
    ...
    String TYPE="org.eclipse.linuxtools.stap.ediotr.color.type"; //$NON-NLS-1$
    String DEFAULT="org.eclipse.linuxtools.stap.ediotr.color.default"; //$NON-NLS-1$
    String EMBEDDED ="org.eclipse.linuxtools.stap.ediotr.color.embedded"; //$NON-NLS-1$
    String EMBEDDEDC="org.eclipse.linuxtools.stap.ediotr.color.embeddedc"; //$NON-NLS-1$
}

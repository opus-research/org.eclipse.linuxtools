...
/**
 * Handler for command in charge of toggling comment prefixes.
 * Based on org.eclipse.cdt.internal.ui.actions.ToggleCommentAction.
 */
public class ToggleCommentHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) {
		...
		if (isSelectionCommented(editor)) {
	 ...
	 */
	private boolean isSelectionCommented(ITextEditor editor) {
	 ...
	 * @param startLine Start line in document
	 * @param endLine End line in document
	 * @param prefix Possible comment prefixes
	 * @param document The document
	 ...
	 *             begin of line
	 */
	private boolean isBlockCommented(int startLine, int endLine, String prefix,
			IDocument document) {
		try {

...
public class ProviderProfileConstants {
	...
	/**
	 * Key to acquire the extension point class parameter containing the profiling type.
	 */
	public static final String INIT_DATA_TYPE_KEY = "type"; //$NON-NLS-1$

	/**
	 * Key to acquire the extension point class parameter containing the name to be used by the options tab.
	 */
	public static final String INIT_DATA_NAME_KEY = "name"; //$NON-NLS-1$

	/**
	 * Key to acquire the extension point class parameter containing the configuration type identifier.
	 */
